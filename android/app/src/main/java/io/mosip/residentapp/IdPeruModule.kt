...
class IdPeruModule(private val reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {
    ...
    companion object {
        ...
        private const val DEFAULT_PACKAGE_NAME = "pe.gob.reniec.idperu"
        private const val DEFAULT_ACTIVITY_NAME = "pe.gob.reniec.idperu.AuthActivity"
        private const val DEFAULT_INPUT_KEY = "auth_params"
